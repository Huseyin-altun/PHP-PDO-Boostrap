<center>
    ...
    <h2>ODEV YUKLE  GOR DEGERLENDIR YORUM YAP </h2>
...
$sql=$db->query("select * from gonderilenodev ",PDO::FETCH_ASSOC);

foreach ($sql as $satir) {

    $a=$satir['dosyaadi'];

    echo"$a<a href='$a' class='btn btn-primary'>INDIR</a><br>";
...
if($_POST){
    ...
    if (move_uploaded_file($_FILES["resim"]["tmp_name"],$yeni_ad)) {
        ...
        $sorgu = $db->prepare("INSERT INTO verilenodev  SET dosyaadi=:dosyaadi,detay=:detay");
